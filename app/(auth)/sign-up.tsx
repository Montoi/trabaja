...
export default function SignUpScreen() {
    ...
    // Theme Primary Color
    const PRIMARY_COLOR = '#7F3DFF'; // User requested this purple
    ...
    return (
        ...
        >
            ...
            {/* Sign Up Button */}
            <Pressable style={[styles.primaryButton, { backgroundColor: PRIMARY_COLOR }]}>
            ...
            <View style={styles.footerLink}>
                ...
                <Pressable onPress={() => router.push('/(auth)/login')}>
                    <Text style={[styles.linkText, { color: PRIMARY_COLOR }]}>Sign in</Text>
                </Pressable>
            </View>
        </ScrollView>
    );
...
const styles = StyleSheet.create({
    ...
    input: {
        backgroundColor: '#F8F8FA', // input-light
        borderRadius: 16,
        paddingVertical: 16,
    ...
    primaryButton: {
        ...
        shadowOpacity: 0.2, // shadow-lg equivalent
        shadowRadius: 12,
        elevation: 6,
    },
    primaryButtonText: {
    ...
    dividerContainer: {
        flexDirection: 'row',
        alignItems: 'center',
        marginVertical: 40, // mt-12 mb-8 roughly
    },
    dividerLine: {
        flex: 1,
        height: 1,
